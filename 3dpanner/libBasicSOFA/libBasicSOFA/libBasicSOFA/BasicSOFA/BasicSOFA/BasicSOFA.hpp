...
namespace BasicSOFA
{
    ...
    struct SOFACoordinateMap
    {
        ...
        std::vector<std::unordered_map<int, size_t>> thetaMaps;
    ...
    public:
        ...
        void            listAllDatasetNames(const H5::Group& group, const std::string& prefix = "");
        ...
        const std::vector<double>& getRadiusList() const { return radiusList; }
        const std::vector<double>& getPhiList() const { return phiList; }
        const std::vector<double>& getThetaList() const { return thetaList; }

        std::vector<double> sourcePositionCoordinates;
    ...
    protected:
        ...
        std::unordered_map<int, size_t>  radiusMap;
        
        static constexpr double             epsilon = 0.1;
        
        bool                                dataLoaded;

        void loadSourcePositions();
    };
}
